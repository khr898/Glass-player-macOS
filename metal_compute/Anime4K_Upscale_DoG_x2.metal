...
float4 hook(float2 mtlPos, sampler textureSampler, texture2d<float, access::sample> HOOKED, texture2d<float, access::sample> GAUSS_X2, texture2d<float, access::sample> MAIN) {
...
float4 hook(float2 mtlPos, sampler textureSampler, texture2d<float, access::sample> HOOKED, texture2d<float, access::sample> LINELUMA, texture2d<float, access::sample> GAUSS_X2, texture2d<float, access::sample> MAIN) {
