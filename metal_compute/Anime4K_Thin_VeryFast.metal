...
kernel void Anime4K_Thin_VeryFast_pass0_Anime4K_v3_2_Thin_VeryFast_Luma(
...
kernel void Anime4K_Thin_VeryFast_pass1_Anime4K_v3_2_Thin_VeryFast_Sobel_X(
...
static float4 hook_pass2(float2 mtlPos, sampler textureSampler, texture2d<float, access::sample> LINESOBEL, texture2d<float, access::sample> MAIN) {
	...
	float ty = LINESOBEL_texOff(float2(0.0, -0.25)).y;
	float by = LINESOBEL_texOff(float2(0.0, 0.25)).y;
...
kernel void Anime4K_Thin_VeryFast_pass2_Anime4K_v3_2_Thin_VeryFast_Sobel_Y(
...
kernel void Anime4K_Thin_VeryFast_pass3_Anime4K_v3_2_Thin_VeryFast_Gaussian_X(
    texture2d<float, access::sample> HOOKED [[texture(0)]],
...
kernel void Anime4K_Thin_VeryFast_pass4_Anime4K_v3_2_Thin_VeryFast_Gaussian_Y(
    texture2d<float, access::sample> HOOKED [[texture(0)]],
    texture2d<float, access::sample> LINESOBEL [[texture(1)]],
    texture2d<float, access::sample> MAIN [[texture(2)]],
    texture2d<float, access::write> output [[texture(3)]],
...
kernel void Anime4K_Thin_VeryFast_pass5_Anime4K_v3_2_Thin_VeryFast_Kernel_X(
    texture2d<float, access::sample> LINESOBEL [[texture(0)]],
    texture2d<float, access::sample> MAIN [[texture(1)]],
    texture2d<float, access::write> output [[texture(2)]],
    uint2 gid [[thread_position_in_grid]],
...
kernel void Anime4K_Thin_VeryFast_pass6_Anime4K_v3_2_Thin_VeryFast_Kernel_Y(
    texture2d<float, access::sample> LINESOBEL [[texture(0)]],
    texture2d<float, access::sample> MAIN [[texture(1)]],
    texture2d<float, access::write> output [[texture(2)]],
    uint2 gid [[thread_position_in_grid]],
...
kernel void Anime4K_Thin_VeryFast_pass7_Anime4K_v3_2_Thin_VeryFast_Warp(
    texture2d<float, access::sample> HOOKED [[texture(0)]],
    texture2d<float, access::sample> LINESOBEL [[texture(1)]],
    texture2d<float, access::sample> MAIN [[texture(2)]],
    texture2d<float, access::write> output [[texture(3)]],
