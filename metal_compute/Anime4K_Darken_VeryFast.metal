...
kernel void Anime4K_Darken_VeryFast_pass0_Anime4K_v3_2_Darken_DoG_HQ_Luma(
...
kernel void Anime4K_Darken_VeryFast_pass1_Anime4K_v3_2_Darken_DoG_VeryFast_Gaussian_X(
    texture2d<float, access::sample> HOOKED [[texture(0)]],
...
kernel void Anime4K_Darken_VeryFast_pass2_Anime4K_v3_2_Darken_DoG_VeryFast_Gaussian_Y(
    texture2d<float, access::sample> HOOKED [[texture(0)]],
    texture2d<float, access::sample> LINELUMA [[texture(1)]],
...
kernel void Anime4K_Darken_VeryFast_pass3_Anime4K_v3_2_Darken_DoG_VeryFast_Gaussian_X(
    texture2d<float, access::sample> HOOKED [[texture(0)]],
...
kernel void Anime4K_Darken_VeryFast_pass4_Anime4K_v3_2_Darken_DoG_VeryFast_Gaussian_Y(
    texture2d<float, access::sample> HOOKED [[texture(0)]],
    texture2d<float, access::sample> LINEKERNEL [[texture(1)]],
    texture2d<float, access::sample> MAIN [[texture(2)]],
    texture2d<float, access::write> output [[texture(3)]],
...
kernel void Anime4K_Darken_VeryFast_pass5_Anime4K_v3_2_Darken_DoG_VeryFast_Upsample(
    texture2d<float, access::sample> HOOKED [[texture(0)]],
    texture2d<float, access::sample> LINEKERNEL [[texture(1)]],
    texture2d<float, access::sample> MAIN [[texture(2)]],
    texture2d<float, access::write> output [[texture(3)]],
