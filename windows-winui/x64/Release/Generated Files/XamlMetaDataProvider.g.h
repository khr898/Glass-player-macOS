...
namespace winrt::GlassPlayer::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, GlassPlayer::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = GlassPlayer::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"GlassPlayer.XamlMetaDataProvider";
        }
    };
}
namespace winrt::GlassPlayer::factory_implementation
{
    ...
    {
        using instance_type = GlassPlayer::XamlMetaDataProvider;
