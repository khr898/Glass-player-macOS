...
namespace winrt::GlassPlayer::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, GlassPlayer::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = GlassPlayer::MainWindow;
        ...
        {
            return L"GlassPlayer.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::GlassPlayer::factory_implementation
{
    ...
    {
        using instance_type = GlassPlayer::MainWindow;
