...
namespace winrt::impl
{
    ...
    {
        void* swapChain{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Canvas::ICanvasSwapChainStatics)->CreateForWindowIdWithDpi(*(void**)(&resourceCreator), impl::bind_in(windowId), width, height, dpi, &swapChain));
        return winrt::Microsoft::Graphics::Canvas::CanvasSwapChain{ swapChain, take_ownership_from_abi };
    }
    ...
    {
        void* swapChain{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Microsoft::Graphics::Canvas::ICanvasSwapChainStatics)->CreateForWindowIdWithAllOptions(*(void**)(&resourceCreator), impl::bind_in(windowId), width, height, dpi, static_cast<int32_t>(format), bufferCount, &swapChain));
        return winrt::Microsoft::Graphics::Canvas::CanvasSwapChain{ swapChain, take_ownership_from_abi };
    }
