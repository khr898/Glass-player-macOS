...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_SHIM(winrt::Windows::System::Power::Thermal::IPowerThermalChannelDataConsumer)->remove_ChannelDataReceived(impl::bind_in(token));
    }
    ...
    {
        WINRT_IMPL_SHIM(winrt::Windows::System::Power::Thermal::IPowerThermalChannelDataConsumer)->remove_BackEndStatusChanged(impl::bind_in(token));
    }
    ...
    {
        WINRT_IMPL_SHIM(winrt::Windows::System::Power::Thermal::IPowerThermalChannelDataProducer)->remove_BackEndStatusChanged(impl::bind_in(token));
    }
