...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_AI_Actions_Hosting_IActionCatalog3<D>::GetActionsForCurrentApp() const
    {
        uint32_t result_impl_size{};
        void** result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::AI::Actions::Hosting::IActionCatalog3)->GetActionsForCurrentApp(&result_impl_size, &result));
        return com_array<winrt::Windows::AI::Actions::Hosting::ActionDefinition>{ result, result_impl_size, take_ownership_from_abi };
    }
    ...
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::AI::Actions::Hosting::IActionDefinition4)->get_IsCurrentlyAvailable(&value));
        return value;
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::AI::Actions::Hosting::IActionDefinition5)->GetIconFullPath(*(void**)(&qualifierValues), &result));
