...
void RcloneBrowser::setupUi()
{
...
#ifdef _WIN32
    WinOSIntegration::instance().applyFrostedGlass((HWND)winId());
#endif
    ...
    setStyleSheet(
        QString(
            ...
            "  font-weight: bold; "
            "} "
        ).arg(Theme::kBgTranslucent, Theme::kBgSurfaceSecondary, Theme::kTextPrimary, Theme::kBorderDefault, Theme::kFontFamily,
...
void RcloneBrowser::changeEvent(QEvent *event)
{
